# 03 - Typeglobs and Symbols Overview

## Learning Goal

Learn typeglobs and symbols overview in Perl well enough to read examples, edit them, and use the idea in a small program.
...
In Perl, this topic shows up often at the advanced level. Focus on the shape of the problem first: what data enters, what work happens, and what result should come out.
