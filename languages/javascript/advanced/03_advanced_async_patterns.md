# 03 - Advanced Async Patterns

## Learning Goal

Learn advanced async patterns in JavaScript well enough to read examples, edit them, and use the idea in a small program.
...
In JavaScript, this topic shows up often at the advanced level. Focus on the shape of the problem first: what data enters, what work happens, and what result should come out.
