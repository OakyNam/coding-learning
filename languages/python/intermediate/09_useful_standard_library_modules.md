# 09 - Useful Standard Library Modules

## Learning Goal

Learn useful standard library modules in Python well enough to read examples, edit them, and use the idea in a small program.
