...
This level contains detailed lessons for PHP. Work through them in order, run the examples, and keep a notes file with what you learn.

## Lessons

1. [Dependency Injection](01_dependency_injection.md)
2. [Routing](02_routing.md)
3. [Security](03_security.md)
4. [Authentication](04_authentication.md)
5. [APIs](05_apis.md)
6. [Performance](06_performance.md)
7. [Queues and Jobs](07_queues_and_jobs.md)
