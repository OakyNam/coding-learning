# 08 - Build Tools and Makefiles

## Learning Goal

Learn build tools and makefiles in C well enough to read examples, edit them, and use the idea in a small program.
...
In C, this topic shows up often at the intermediate level. Focus on the shape of the problem first: what data enters, what work happens, and what result should come out.
