# 01 - Setup and Script Structure

## Learning Goal

Learn setup and script structure in Perl well enough to read examples, edit them, and use the idea in a small program.
...
In Perl, this topic shows up often at the beginner level. Focus on the shape of the problem first: what data enters, what work happens, and what result should come out.
