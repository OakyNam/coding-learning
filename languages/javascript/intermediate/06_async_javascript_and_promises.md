# 06 - Async JavaScript and Promises

## Learning Goal

Learn async javascript and promises in JavaScript well enough to read examples, edit them, and use the idea in a small program.
