# 06 - Reflection and Annotations

## Learning Goal

Learn reflection and annotations in Java well enough to read examples, edit them, and use the idea in a small program.
...
In Java, this topic shows up often at the advanced level. Focus on the shape of the problem first: what data enters, what work happens, and what result should come out.
