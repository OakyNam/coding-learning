...
Learn building http apis in Java well enough to read examples, edit them, and use the idea in a small program.
...
In Java, this topic shows up often at the intermediate level. Focus on the shape of the problem first: what data enters, what work happens, and what result should come out.

## Example

```
String[] items = {"api", "json", "test"};
