# 06 - Working with JSON and APIs

## Learning Goal

Learn working with json and apis in Python well enough to read examples, edit them, and use the idea in a small program.
...
In Python, this topic shows up often at the intermediate level. Focus on the shape of the problem first: what data enters, what work happens, and what result should come out.
...
5. Try reading or querying a small JSON document with a JSONPath-style path such as $.items[0].name.
